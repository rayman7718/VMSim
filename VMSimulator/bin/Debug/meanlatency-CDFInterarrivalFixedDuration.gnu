...
GNUTERM = "x11"
plot "./stats-CDFInterarrivalFixedDuration-LRUReactivePolicy.txt" using 1:2 w lp,  "./stats-CDFInterarrivalFixedDuration-BeladyEviction.txt" using 1:2 w lp,  "./stats-CDFInterarrivalFixedDuration-SlidingWindowLastInterarrival.txt" using 1:2 w lp,  "./stats-CDFInterarrivalFixedDuration-SlidingWindowARMA.txt" using 1:2 w lp
#    EOF
